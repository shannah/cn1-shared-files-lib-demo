 ...
 * @author Shai Almog
 */
public class SharedFilesLibTestStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "SharedFilesLibTest";
    ...
    private SharedFilesLibTest mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new SharedFilesLibTestStub());
    }
        ...
        Display.getInstance().callSerially(new Runnable() {
            ...
            public void run() {
                if(Display.getInstance().isEdt()) {
                    mainApp = new SharedFilesLibTest();
                    mainApp.init(this);
                    mainApp.start();
